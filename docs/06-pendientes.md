...
| P-09 | **P1** | **Modo 2.5D**: fases A–D cerradas (2026-09-18); sigue E (agua y explosiones sincronizadas, cono de la linterna sorda, tamaño de ficha >1, cascada en servidor al quitar `newobj`/`newchar`, cierre y archivo de 08). **Mergeado en `main` y empujado el 2026-09-18 (`2853f49`); despliegue aplazado a la fase E** por decisión del usuario — producción sigue en `34a7ba4` | `check` y `test:ui` verdes, docs 01–07 al día, desplegado |
