...
| P-09 | **P1** | **Modo 2.5D**: fase A cerrada; seguir con B–E (antes de cada fase, expandir su plan al detalle del plan A leyendo el código real). Rama `modo-25d-fase-a` (no está en `origin`). Todo en [08](08-traspaso-opencode.md) | Cada fase: `check` y `test:ui` verdes, docs 01–07 al día, desplegado |
