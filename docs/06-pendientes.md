...
| P-09 | **P1** | **Modo 2.5D**: terminar la fase A (tareas 6–12 del plan) y seguir con B–E. Rama `modo-25d-fase-a` (no está en `origin`). Todo en [08](08-traspaso-opencode.md) | Fase A: `test:ui` con paso 2.5D verde, motor en 10 módulos, docs 01–07 al día, desplegado |
