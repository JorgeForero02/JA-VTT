...
const UI={role:'player',realRole:'player',me:null,board:null,scene:null,scenes:[],where:{},tool:'select',wallType:'wall',wallShape:'chain',zoneShape:'poly',zpoly:null,arc:null,curve:null,libCat:'all',upCat:'board',lightPreset:'torch',planShape:'line',viewAs:'party',fogOf:'new',preview:true,paintMat:1,objKind:'arbol',waterMode:'verter',
...
function animFactor(src,t){
  // r: radio total · rb: radio brillante · i: intensidad de la máscara · g: intensidad del tinte
  if(!S.animate||!src.anim||src.anim==='none')return{r:1,rb:1,i:1,g:1};
